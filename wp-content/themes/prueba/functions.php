...
function assets(){
    ...
    wp_enqueue_script('boostrap', 'https://cdn.jsdelivr.net/npm/bootstrap@5.0.2/dist/js/bootstrap.min.js', array('jquery', 'popper'), '5.0.2', true);
...
function productos_type(){
    ...
    $args = array(
        'label' => 'Productos',
        'description' => 'Productos bicicletas',
        'labels' => $labels,
